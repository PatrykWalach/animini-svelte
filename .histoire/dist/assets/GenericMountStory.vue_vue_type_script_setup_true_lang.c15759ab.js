import { X as SvelteComponentDev, Y as init, Z as safe_not_equal, _ as dispatch_dev, $ as create_slot, a0 as validate_slots, a1 as element, a2 as claim_element, a3 as children, a4 as detach_dev, a5 as attr_dev, a6 as add_location, a7 as insert_hydration_dev, a8 as update_slot_base, a9 as get_all_dirty_from_scope, aa as get_slot_changes, ab as prop_dev, ac as transition_in, ad as transition_out, ae as create_component, af as claim_component, ag as mount_component, ah as destroy_component, ai as space, aj as claim_space, ak as text, al as claim_text, am as Comp1, an as Logo_square, ao as Logo_dark, ap as useDark, aq as useToggle, f as watch, ar as markRaw, R as reactive, d as defineComponent, k as ref, as as watchEffect, o as openBlock, c as createBlock, m as mergeProps, at as resolveDynamicComponent, q as createCommentVNode } from "./vendor.ebc1f38e.js";
...
function create_fragment$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(button, "class", "relative flex items-center justify-center gap-2 overflow-hidden rounded-[1.25rem] text-label-lg text-primary surface state-primary min-w-[3rem] h-10 px-3 hover:state-hover focus:state-focus disabled:text-on-surface/[.38] disabled:state-none");
...
class BtnText extends SvelteComponentDev {
  ...
  get disabled() {
    throw new Error("<BtnText>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set disabled(value) {
    throw new Error("<BtnText>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
}
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor.ebc1f38e.js").then((n) => n.aX), true ? [] : void 0),
  "svelte3": () => __vitePreload(() => import("./vendor.ebc1f38e.js").then((n) => n.aY), true ? [] : void 0)
};
const __default__ = {
  inheritAttrs: false
};
