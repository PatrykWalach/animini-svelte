...
<label
	for={id}
	class="pointer-events-none absolute -top-2 left-4 text-body-sm text-on-surface-variant transition-all after:content-['*'] group-hover:text-on-surface peer-placeholder-shown:top-4 peer-placeholder-shown:text-body-lg peer-invalid:text-error group-data-[error=true]:text-error group-hover:group-data-[error=true]:text-on-error-container group-hover:peer-invalid:text-on-error-container group-focus-within:text-primary group-focus-within:group-hover:text-primary group-focus-within:peer-placeholder-shown:-top-2 group-focus-within:peer-placeholder-shown:left-4 group-focus-within:peer-placeholder-shown:text-body-sm group-data-[error=true]:group-focus-within:text-error group-focus-within:peer-invalid:text-error group-hover:group-data-[error=true]:group-focus-within:text-error group-hover:group-focus-within:peer-invalid:text-error peer-disabled:text-on-surface/[.38] group-hover:peer-disabled:text-on-surface/[.38] peer-placeholder-shown:peer-[]/leading:left-12"
>
	<slot />
</label>
<fieldset
